...
class SaleOrder(models.Model):
    ...
    def onchange_partner_id_warning(self):
        ...
        #cambiamos la posicion fiscal
        self.set_fiscal_position()
    ...
    def set_fiscal_position(self):
        if self.partner_id.property_account_position_id:
            self.fiscal_position_id = self.partner_id.property_account_position_id
        elif self.type_id.fiscal_position_id and not self.partner_id.property_account_position_id:
